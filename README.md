...
Below is a simple illustration of detected market regimes:

![Regime Detection](images/regime_detection_visual.png)
...
- Fixed thresholds rather than adaptive thresholds
...
- Adding additional visual regime charts
